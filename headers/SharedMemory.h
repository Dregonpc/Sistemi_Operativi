...
typedef struct {
    // Contatori globali
    int utenti_serviti_tot_sim; // numero di utenti serviti totali nella simulazione //? DONE
    int utenti_non_serviti_tot_sim; // numero di utenti non serviti totali nella simulazione //? DONE
    int utenti_non_serviti_tot_day; // numero di utenti serviti totali nella giornata (da usare per explode) //? DONE
    int servizi_erogati_tot_sim; // numero di servizi erogati totali nella simuazione //? DONE
    ...
    int operatori_attivi_day; // numero di operatori attivi durante la giornata //? DONE
    int operatori_attivi_sim; // numero di operatori attivi durante la simulazione //? DONE
    int pause_effettuate_sim; // numero totale di pause effettuate durante la simulazione //? DONE
